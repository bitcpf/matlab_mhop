...
% Generate regular grid Temporary use uniform demand of all node, could be
% modified later Use Arbitrary link capacity and no inter node interference
% right now, could be modified later according to the interference range
% defined
...
%  bands=[2.4*10^9,2.4*10^9,2.4*10^9,2.4*10^9];
  ...
  % interference range Define single link capacity and threshold in the
  % future need to define
    % inter node interference distance Temporary define uniform capacity
    % High freq first
...
% Get 1 hop Adjancy matrix, Ad_d1 is the adjancy matrix for sum of all
% band, Ad_multi is 3 dimension matrix have the info of each band using for
% building sub tree
