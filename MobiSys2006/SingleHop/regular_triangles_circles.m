...
function [validx,validy] = regular_triangles_circles(rad,numrads,bridgerad,hcc,melcher)
...
[tfaxvec,tfayvec] = tesselate_triangles(maxx,maxy,tfax,tfay,pixelrad); %tesselate the whole space
[melcherxvec,melcheryvec] = tesselate_triangles(maxx,maxy,melcherx,melchery,pixelrad);
[hccxvec,hccyvec] = tesselate_triangles(maxx,maxy,hccx,hccy,pixelrad);
[ymcaxvec,ymcayvec] = tesselate_triangles(maxx,maxy,ymcax,ymcay,pixelrad);
